...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Profile.ip_address'
        db.add_column(u'profiles_profile', 'ip_address',
                      self.gf('django.db.models.fields.CharField')(default='0:0:0', max_length=120),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Profile.ip_address'
        db.delete_column(u'profiles_profile', 'ip_address')
