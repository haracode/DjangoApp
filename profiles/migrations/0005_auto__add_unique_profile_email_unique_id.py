...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'Profile', fields ['email', 'unique_id']
        db.create_unique(u'profiles_profile', ['email', 'unique_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'Profile', fields ['email', 'unique_id']
        db.delete_unique(u'profiles_profile', ['email', 'unique_id'])
